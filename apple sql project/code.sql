----APPLE SALES PROJECT - 1MILLION ROW SALES DATASETS
...
-----Execution Time: 84.264 ms
----Planning Time: 0.059 ms
----et after index =10-15ms
explain analyze
SELECT*FROM sales
...
-----Execution Time: 43.305 ms
----Planning Time: 0.139 ms
----et after index =1.635ms
explain analyze
SELECT*FROM sales
...
-- Q.7 Count the number of unique products sold in the last two year.

SELECT 
	COUNT(DISTINCT product_id)
FROM sales
WHERE sale_date >= (CURRENT_DATE - INTERVAL '2year')
